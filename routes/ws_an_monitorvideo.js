...
router.post('/', async (req, res) => {
  try {
    ...
    if ('ws_an_monitorvideo' === 'voluntreedetailes') {
    ...
    if ('ws_an_monitorvideo' === 'volutreeapprove' || 'ws_an_monitorvideo' === 'volutreeapprove1') {
    ...
    if ('ws_an_monitorvideo' === 'volutreereject') {
    ...
    if ('ws_an_monitorvideo' === 'ws_an_monitorapprove') {
    ...
    if ('ws_an_monitorvideo' === 'ws_an_monitorrelocate') {
