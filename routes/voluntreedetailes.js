...
router.post('/', async (req, res) => {
  try {
    ...
    if ('voluntreedetailes' === 'voluntreedetailes') {
    ...
    if ('voluntreedetailes' === 'volutreeapprove' || 'voluntreedetailes' === 'volutreeapprove1') {
    ...
    if ('voluntreedetailes' === 'volutreereject') {
    ...
    if ('voluntreedetailes' === 'ws_an_monitorapprove') {
    ...
    if ('voluntreedetailes' === 'ws_an_monitorrelocate') {
