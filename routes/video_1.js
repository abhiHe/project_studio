...
router.post('/', upload.single('video'), async (req, res) => {
  try {
    ...
    if ('video_1' === 'video' || 'video_1' === 'video_1') {
      if (video_id) {
