...
router.post('/', async (req, res) => {
  try {
    ...
    if ('ws_updateamber' === 'ws_an_ambersearch') {
    ...
    if ('ws_updateamber' === 'ws_amberdropdown') {
    ...
    if ('ws_updateamber' === 'amberalert' || 'ws_updateamber' === 'send_amber') {
    ...
    if ('ws_updateamber' === 'inactivateAmberAlert') {
    ...
    if ('ws_updateamber' === 'ws_updateamber') {
