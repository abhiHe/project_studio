...
router.post('/', async (req, res) => {
  try {
    ...
    if ('amberalert' === 'ws_an_ambersearch') {
    ...
    if ('amberalert' === 'ws_amberdropdown') {
    ...
    if ('amberalert' === 'amberalert' || 'amberalert' === 'send_amber') {
    ...
    if ('amberalert' === 'inactivateAmberAlert') {
