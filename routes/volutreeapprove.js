...
router.post('/', async (req, res) => {
  try {
    ...
    if ('volutreeapprove' === 'voluntreedetailes') {
    ...
    if ('volutreeapprove' === 'volutreeapprove' || 'volutreeapprove' === 'volutreeapprove1') {
    ...
    if ('volutreeapprove' === 'volutreereject') {
    ...
    if ('volutreeapprove' === 'ws_an_monitorapprove') {
    ...
    if ('volutreeapprove' === 'ws_an_monitorrelocate') {
