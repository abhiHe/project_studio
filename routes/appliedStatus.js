...
router.post('/', async (req, res) => {
  try {
    ...
    if ('appliedStatus' === 'ws_an_approverregister') {
    ...
    if ('appliedStatus' === 'ws_an_approverlist') {
    ...
    if ('appliedStatus' === 'ws_an_applyprofile') {
    ...
    if ('appliedStatus' === 'ws_an_vgroupapprove' || 'appliedStatus' === 'ws_an_vsgroupapprove') {
    ...
    if ('appliedStatus' === 'ws_an_vsgroupreject') {
    ...
    if ('appliedStatus' === 'ws_an_vsgroupcase') {
    ...
    if ('appliedStatus' === 'ws_an_vsgroupaddalert') {
      const docRef = db.collection('audit_logs').doc();
