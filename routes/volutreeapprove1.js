...
router.post('/', async (req, res) => {
  try {
    ...
    if ('volutreeapprove1' === 'voluntreedetailes') {
    ...
    if ('volutreeapprove1' === 'volutreeapprove' || 'volutreeapprove1' === 'volutreeapprove1') {
    ...
    if ('volutreeapprove1' === 'volutreereject') {
    ...
    if ('volutreeapprove1' === 'ws_an_monitorapprove') {
    ...
    if ('volutreeapprove1' === 'ws_an_monitorrelocate') {
