...
router.post('/', async (req, res) => {
  try {
    ...
    if ('send_amber' === 'ws_an_ambersearch') {
    ...
    if ('send_amber' === 'ws_amberdropdown') {
    ...
    if ('send_amber' === 'amberalert' || 'send_amber' === 'send_amber') {
    ...
    if ('send_amber' === 'inactivateAmberAlert') {
