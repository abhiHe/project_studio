...
router.post('/', async (req, res) => {
  try {
    ...
    if ('ws_an_monitorapprove' === 'voluntreedetailes') {
    ...
    if ('ws_an_monitorapprove' === 'volutreeapprove' || 'ws_an_monitorapprove' === 'volutreeapprove1') {
    ...
    if ('ws_an_monitorapprove' === 'volutreereject') {
    ...
    if ('ws_an_monitorapprove' === 'ws_an_monitorapprove') {
    ...
    if ('ws_an_monitorapprove' === 'ws_an_monitorrelocate') {
