...
router.post('/', async (req, res) => {
  try {
    ...
    if ('ws_an_monitorrelocate' === 'voluntreedetailes') {
    ...
    if ('ws_an_monitorrelocate' === 'volutreeapprove' || 'ws_an_monitorrelocate' === 'volutreeapprove1') {
    ...
    if ('ws_an_monitorrelocate' === 'volutreereject') {
    ...
    if ('ws_an_monitorrelocate' === 'ws_an_monitorapprove') {
    ...
    if ('ws_an_monitorrelocate' === 'ws_an_monitorrelocate') {
