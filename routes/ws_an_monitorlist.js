...
router.post('/', async (req, res) => {
  try {
    ...
    if ('ws_an_monitorlist' === 'voluntreedetailes') {
    ...
    if ('ws_an_monitorlist' === 'volutreeapprove' || 'ws_an_monitorlist' === 'volutreeapprove1') {
    ...
    if ('ws_an_monitorlist' === 'volutreereject') {
    ...
    if ('ws_an_monitorlist' === 'ws_an_monitorapprove') {
    ...
    if ('ws_an_monitorlist' === 'ws_an_monitorrelocate') {
